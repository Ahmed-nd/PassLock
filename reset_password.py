...
class ResetPassword(tk.Frame):
    def __init__(self, master=None):
        ...
        # background
        # Add image file
        self.bg = tk.PhotoImage(file="images/reset password page.png")
        bg_label3 = tk.Label(image=self.bg)
        bg_label3.place(x=-2, y=-2)

        # Program UI

        self.key_label = tk.Label(text="                    Key", font="Sans 13", bg="#0001e6")
        ...
        # n, e, s, w, ne, se, sw, nw
        self.key_label.place(x=180, y=320, width=130, height=21)
        self.key_entry.place(x=320, y=320, width=200, height=21)
